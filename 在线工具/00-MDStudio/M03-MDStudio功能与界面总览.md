...
![mdstudio_map](../../images/articles/在线工具/M03-MDStudio功能与界面总览/web/M03-hero-mdstudio_map.webp)
...
下面按界面顺序逐一介绍九个 Tab，分别说明其**功能、输入、输出和输出用途**。输出文件会出现在左侧工作区，结构类文件通常可以在右侧预览。
...
5. 九个 Tab 均有独立详解，四条常见路径覆盖大多数使用场景。
