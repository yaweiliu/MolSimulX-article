...
读者视角的站内入口见 [在线资源/资源导航.md](在线资源/资源导航.md)。完整约定见 [内容写作与发布手册.md](内容写作与发布手册.md)（**勿上传 WordPress**）。
...
3. 写作规范、导语厚度、互链规则 → 打开 [内容写作与发布手册.md](内容写作与发布手册.md) **一、写作规范**。  
...
| 问题 | 文档 |
|------|------|
| 文风、禁止套话、互链、YAML | [内容写作与发布手册.md](内容写作与发布手册.md) · 一 |
| `publish.py`、配图、status、paywall | 同手册 · 二 |
| 编号总表、学习路径、待写 | 同手册 · 三 |
| 读者阅读路径 | [在线资源/资源导航.md](在线资源/资源导航.md) |
| ML / 实战 / 在线工具选题 | 根目录各 `*规划.md` |
